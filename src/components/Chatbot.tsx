                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <motion.button
                                            ...
                                            className="bg-[var(--color-primary)] text-white h-10 w-10 rounded-full flex items-center justify-center hover:bg-[var(--color-primary-dark)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 disabled:opacity-50 shrink-0 shadow-md"
                                        >
