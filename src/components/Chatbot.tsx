                ...
                {isOpen ? (
                    ...
                    >
                        ...
                        <div className="bg-[var(--color-primary)] px-4 py-3 flex items-center justify-between text-white shadow-sm shrink-0">
                            ...
                            <button onClick={() => setIsOpen(false)} aria-label="Close chatbot" className="hover:bg-white/20 rounded-full p-1 transition-colors focus-visible:ring-2 focus-visible:outline-none">
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <motion.button
                                            ...
                                            className="bg-[var(--color-primary)] text-white h-10 w-10 rounded-full flex items-center justify-center hover:bg-[var(--color-primary-dark)] transition-colors disabled:opacity-50 shrink-0 shadow-md focus-visible:ring-2 focus-visible:outline-none"
                                        >
                    ...
                    <motion.button
                        ...
                        className="h-14 w-14 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white rounded-full shadow-[var(--shadow-elevated)] flex items-center justify-center focus-visible:ring-2 focus-visible:outline-none"
                    >
