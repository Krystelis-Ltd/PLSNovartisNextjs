      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50 dark:bg-slate-950/50 text-sm custom-scrollbar">
              {messages.length === 0 && (
                ...
                >
                  <span
                    className="material-symbols-outlined text-4xl opacity-50 block mb-2"
                    aria-hidden="true"
                  >
                    smart_toy
                  </span>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <motion.button
                      ...
                      className="bg-[var(--color-primary)] text-white h-10 w-10 rounded-full flex items-center justify-center hover:bg-[var(--color-primary-dark)] transition-colors disabled:opacity-50 shrink-0 shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-primary)]"
                    >
                      <span
          ...
          <motion.button
            ...
            className="h-14 w-14 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white rounded-full shadow-[var(--shadow-elevated)] flex items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2"
          >
            <span
